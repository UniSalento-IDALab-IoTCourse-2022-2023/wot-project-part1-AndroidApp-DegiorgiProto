...
class SeeGrapHActivity : AppCompatActivity() {
    ...
    data class fascia(val _id: String, val heartRate: String, val rrs: String, val rr: String, val email_address: String, val date: String, val hour: String)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val entries2 = array.map {
            Entry(stringToFloat(it.hour), it.rrs.toFloat())
        }
